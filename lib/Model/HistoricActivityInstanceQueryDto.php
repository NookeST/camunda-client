 ...
 */
class HistoricActivityInstanceQueryDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HistoricActivityInstanceQueryDto';
    ...
    protected static $openAPITypes = [
        ...
        'sorting' => '\NookeST\Camunda\Model\HistoricActivityInstanceQueryDtoSorting[]'
    ];
     ...
     * Sets execution_id
     *
     * @param string|null $execution_id Filter by the id of the execution that executed the activity instance.
     *
     * @return self
     */
     ...
     * Sets activity_id
     *
     * @param string|null $activity_id Filter by the activity id (according to BPMN 2.0 XML).
     *
     * @return self
     */
     ...
     * Sets activity_name
     *
     * @param string|null $activity_name Filter by the activity name (according to BPMN 2.0 XML).
     *
     * @return self
     */
     ...
     * Sets activity_type
     *
     * @param string|null $activity_type Filter by activity type.
     *
     * @return self
     */
     ...
     * Sets task_assignee
     *
     * @param string|null $task_assignee Only include activity instances that are user tasks and assigned to a given user.
     *
     * @return self
     */
     ...
     * Sets finished
     *
     * @param bool|null $finished Only include finished activity instances. Value may only be `true`, as `false` behaves the same as when the property is not set.
     *
     * @return self
     */
     ...
     * Sets unfinished
     *
     * @param bool|null $unfinished Only include unfinished activity instances. Value may only be `true`, as `false` behaves the same as when the property is not set.
     *
     * @return self
     */
     ...
     * Sets canceled
     *
     * @param bool|null $canceled Only include canceled activity instances. Value may only be `true`, as `false` behaves the same as when the property is not set.
     *
     * @return self
     */
     ...
     * Sets complete_scope
     *
     * @param bool|null $complete_scope Only include activity instances which completed a scope. Value may only be `true`, as `false` behaves the same as when the property is not set.
     *
     * @return self
     */
     ...
     * Sets tenant_id_in
     *
     * @param string[]|null $tenant_id_in Must be a JSON array of Strings. An activity instance must have one of the given tenant ids.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $without_tenant_id Only include historic activity instances that belong to no tenant. Value may only be `true`, as `false` is the default behavior.
     *
     * @return self
     */
     ...
     * Gets sorting
     *
     * @return \NookeST\Camunda\Model\HistoricActivityInstanceQueryDtoSorting[]|null
     */
     ...
     * Sets sorting
     *
     * @param \NookeST\Camunda\Model\HistoricActivityInstanceQueryDtoSorting[]|null $sorting Apply sorting of the result
     *
     * @return self
     */
