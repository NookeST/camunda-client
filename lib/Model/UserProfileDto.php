 ...
 */
class UserProfileDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserProfileDto';
     ...
     * Sets last_name
     *
     * @param string|null $last_name The first name of the user.
     *
     * @return self
     */
