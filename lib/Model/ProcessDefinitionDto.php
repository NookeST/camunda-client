...
class ProcessDefinitionDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['diagram'] = $data['diagram'] ?? null;
        $this->container['suspended'] = $data['suspended'] ?? null;
        $this->container['tenant_id'] = $data['tenant_id'] ?? null;
        $this->container['version_tag'] = $data['version_tag'] ?? null;
        $this->container['history_time_to_live'] = $data['history_time_to_live'] ?? null;
        $this->container['startable_in_tasklist'] = $data['startable_in_tasklist'] ?? null;
    }
     ...
     *
     * @param int|null $history_time_to_live History time to live value of the process definition. Is used within [History cleanup](https://docs.camunda.org/manual/7.15/user-guide/process-engine/history/#history-cleanup).
     *
     * @return self
     */
