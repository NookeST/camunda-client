 ...
 */
class RedeploymentDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['resource_ids'] = $data['resource_ids'] ?? null;
        $this->container['resource_names'] = $data['resource_names'] ?? null;
