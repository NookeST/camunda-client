 ...
 */
class CreateIncidentDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateIncidentDto';
     ...
     * Sets incident_type
     *
     * @param string|null $incident_type A type of the new incident.
     *
     * @return self
     */
     ...
     * Sets configuration
     *
     * @param string|null $configuration A configuration for the new incident.
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message A message for the new incident.
     *
     * @return self
     */
