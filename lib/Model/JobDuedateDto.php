...
/**
 * JobDuedateDto Class Doc Comment
 *
 * @category Class
 * @package  NookeST\Camunda
 * @author   OpenAPI Generator team
 ...
 */
class JobDuedateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'JobDuedateDto';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['cascade'] = $data['cascade'] ?? null;
    }
     ...
     * Sets duedate
     *
     * @param \DateTime|null $duedate The date to set when the job has the next execution.
     *
     * @return self
     */
