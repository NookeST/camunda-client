 ...
 */
class FetchExternalTaskTopicDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'tenant_id_in' => 'string[]',
        'process_variables' => 'array<string,object>',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['lock_duration'] = $data['lock_duration'] ?? null;
        $this->container['variables'] = $data['variables'] ?? null;
        $this->container['local_variables'] = $data['local_variables'] ?? false;
        $this->container['business_key'] = $data['business_key'] ?? null;
        $this->container['process_definition_id'] = $data['process_definition_id'] ?? null;
        $this->container['process_definition_id_in'] = $data['process_definition_id_in'] ?? null;
        ...
        $this->container['deserialize_values'] = $data['deserialize_values'] ?? false;
        $this->container['include_extension_properties'] = $data['include_extension_properties'] ?? false;
    }
     ...
     *
     * @param array<string,object>|null $process_variables A `JSON` object used for filtering tasks based on process instance variable values. A property name of the object represents a process variable name, while the property value represents the process variable value to filter tasks by.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $include_extension_properties Determines whether custom extension properties defined in the BPMN activity of the external task (e.g. via the Extensions tab in the Camunda modeler) should be included in the response. Default: false
     *
     * @return self
     */
