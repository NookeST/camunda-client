 ...
 */
class ProcessInstanceQueryDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'or_queries' => '\NookeST\Camunda\Model\ProcessInstanceQueryDto[]',
        'sorting' => '\NookeST\Camunda\Model\ProcessInstanceQueryDtoSorting[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['business_key_like'] = $data['business_key_like'] ?? null;
        $this->container['case_instance_id'] = $data['case_instance_id'] ?? null;
        $this->container['super_process_instance'] = $data['super_process_instance'] ?? null;
        $this->container['sub_process_instance'] = $data['sub_process_instance'] ?? null;
        $this->container['super_case_instance'] = $data['super_case_instance'] ?? null;
        $this->container['sub_case_instance'] = $data['sub_case_instance'] ?? null;
        $this->container['active'] = $data['active'] ?? null;
        $this->container['suspended'] = $data['suspended'] ?? null;
        $this->container['process_instance_ids'] = $data['process_instance_ids'] ?? null;
        $this->container['with_incident'] = $data['with_incident'] ?? null;
        ...
        $this->container['leaf_process_instances'] = $data['leaf_process_instances'] ?? null;
     ...
     * Sets variables
     *
     * @param \NookeST\Camunda\Model\VariableQueryParameterDto[]|null $variables A JSON array to only include process instances that have variables with certain values. The array consists of objects with the three properties `name`, `operator` and `value`. `name` (String) is the variable name, `operator` (String) is the comparison operator to be used and `value` the variable value. The `value` may be String, Number or Boolean.  Valid operator values are: `eq` - equal to; `neq` - not equal to; `gt` - greater than; `gteq` - greater than or equal to; `lt` - lower than; `lteq` - lower than or equal to; `like`.
     *
     * @return self
     */
     ...
     * Gets sorting
     *
     * @return \NookeST\Camunda\Model\ProcessInstanceQueryDtoSorting[]|null
     */
     ...
     * Sets sorting
     *
     * @param \NookeST\Camunda\Model\ProcessInstanceQueryDtoSorting[]|null $sorting Apply sorting of the result
     *
     * @return self
     */
