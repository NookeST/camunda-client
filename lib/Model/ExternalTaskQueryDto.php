 ...
 */
class ExternalTaskQueryDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'sorting' => '\NookeST\Camunda\Model\ExternalTaskQueryDtoSorting[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['external_task_id_in'] = $data['external_task_id_in'] ?? null;
        ...
        $this->container['not_locked'] = $data['not_locked'] ?? null;
        $this->container['with_retries_left'] = $data['with_retries_left'] ?? null;
        $this->container['no_retries_left'] = $data['no_retries_left'] ?? null;
        $this->container['lock_expiration_after'] = $data['lock_expiration_after'] ?? null;
        $this->container['lock_expiration_before'] = $data['lock_expiration_before'] ?? null;
     ...
     *
     * @param \DateTime|null $lock_expiration_after Restrict to external tasks that have a lock that expires after a given date. By [default](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.000+0200`.
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $lock_expiration_before Restrict to external tasks that have a lock that expires before a given date. By [default](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.000+0200`.
     *
     * @return self
     */
     ...
     * Gets sorting
     *
     * @return \NookeST\Camunda\Model\ExternalTaskQueryDtoSorting[]|null
     */
     ...
     * Sets sorting
     *
     * @param \NookeST\Camunda\Model\ExternalTaskQueryDtoSorting[]|null $sorting A JSON array of criteria to sort the result by. Each element of the array is a JSON object that                     specifies one ordering. The position in the array identifies the rank of an ordering, i.e., whether                     it is primary, secondary, etc. The ordering objects have the following properties:                      **Note:** The `sorting` properties will not be applied to the External Task count query.
     *
     * @return self
     */
