...
/**
 * HistoricActivityInstanceQueryDtoSorting Class Doc Comment
 *
 * @category Class
 * @package  NookeST\Camunda
 * @author   OpenAPI Generator team
 ...
 */
class HistoricActivityInstanceQueryDtoSorting implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HistoricActivityInstanceQueryDto_sorting';
    ...
    const SORT_BY_ACTIVITY_INSTANCE_ID = 'activityInstanceId';
    const SORT_BY_INSTANCE_ID = 'instanceId';
    const SORT_BY_EXECUTION_ID = 'executionId';
    const SORT_BY_ACTIVITY_ID = 'activityId';
    const SORT_BY_ACTIVITY_NAME = 'activityName';
    const SORT_BY_ACTIVITY_TYPE = 'activityType';
    ...
    {
        return [
            self::SORT_BY_ACTIVITY_INSTANCE_ID,
            self::SORT_BY_INSTANCE_ID,
            self::SORT_BY_EXECUTION_ID,
            self::SORT_BY_ACTIVITY_ID,
            self::SORT_BY_ACTIVITY_NAME,
            self::SORT_BY_ACTIVITY_TYPE,
