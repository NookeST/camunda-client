...
class JobQueryDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'timers' => 'bool',
        'messages' => 'bool',
        'due_dates' => '\NookeST\Camunda\Model\JobConditionQueryParameterDto[]',
        'create_times' => '\NookeST\Camunda\Model\JobConditionQueryParameterDto[]',
        'with_exception' => 'bool',
        ...
        'sorting' => '\NookeST\Camunda\Model\JobQueryDtoSorting[]'
    ];
     ...
     * Gets due_dates
     *
     * @return \NookeST\Camunda\Model\JobConditionQueryParameterDto[]|null
     */
     ...
     * Sets due_dates
     *
     * @param \NookeST\Camunda\Model\JobConditionQueryParameterDto[]|null $due_dates Only select jobs where the due date is lower or higher than the given date.
     *
     * @return self
     */
     ...
     * Sets create_times
     *
     * @param \NookeST\Camunda\Model\JobConditionQueryParameterDto[]|null $create_times Only select jobs created before or after the given date.
     *
     * @return self
     */
     ...
     * Gets sorting
     *
     * @return \NookeST\Camunda\Model\JobQueryDtoSorting[]|null
     */
     ...
     * Sets sorting
     *
     * @param \NookeST\Camunda\Model\JobQueryDtoSorting[]|null $sorting An array of criteria to sort the result by. Each element of the array is                        an object that specifies one ordering. The position in the array                        identifies the rank of an ordering, i.e., whether it is primary, secondary,                        etc. Does not have an effect for the `count` endpoint.
     *
     * @return self
     */
