...
class TaskQueryDtoSorting implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'sort_by' => 'string',
        'sort_order' => 'string',
        'parameters' => '\NookeST\Camunda\Model\SortTaskQueryParametersDto'
    ];
     ...
     * Gets parameters
     *
     * @return \NookeST\Camunda\Model\SortTaskQueryParametersDto|null
     */
     ...
     * Sets parameters
     *
     * @param \NookeST\Camunda\Model\SortTaskQueryParametersDto|null $parameters parameters
     *
     * @return self
     */
