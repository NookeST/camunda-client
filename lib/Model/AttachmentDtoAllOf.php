 ...
 */
class AttachmentDtoAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets create_time
     *
     * @param \DateTime|null $create_time The time the variable was inserted. [Default format](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/) `yyyy-MM-dd'T'HH:mm:ss.SSSZ`.
     *
     * @return self
     */
     ...
     * Sets removal_time
     *
     * @param \DateTime|null $removal_time The time after which the attachment should be removed by the History Cleanup job. [Default format](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/) `yyyy-MM-dd'T'HH:mm:ss.SSSZ`.
     *
     * @return self
     */
