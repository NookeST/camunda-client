 ...
 */
class TaskQueryDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'active' => 'bool',
        'suspended' => 'bool',
        'task_variables' => '\NookeST\Camunda\Model\VariableQueryParameterDto[]',
        'process_variables' => '\NookeST\Camunda\Model\VariableQueryParameterDto[]',
        'case_instance_variables' => '\NookeST\Camunda\Model\VariableQueryParameterDto[]',
        'variable_names_ignore_case' => 'bool',
        'variable_values_ignore_case' => 'bool',
        'parent_task_id' => 'string',
        'or_queries' => '\NookeST\Camunda\Model\TaskQueryDto[]',
        'sorting' => '\NookeST\Camunda\Model\TaskQueryDtoSorting[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['process_instance_business_key_expression'] = $data['process_instance_business_key_expression'] ?? null;
        ...
        $this->container['process_instance_business_key_like_expression'] = $data['process_instance_business_key_like_expression'] ?? null;
        ...
        $this->container['process_definition_key_in'] = $data['process_definition_key_in'] ?? null;
        $this->container['process_definition_name'] = $data['process_definition_name'] ?? null;
        $this->container['process_definition_name_like'] = $data['process_definition_name_like'] ?? null;
        $this->container['execution_id'] = $data['execution_id'] ?? null;
        $this->container['case_instance_id'] = $data['case_instance_id'] ?? null;
        $this->container['case_instance_business_key'] = $data['case_instance_business_key'] ?? null;
        $this->container['case_instance_business_key_like'] = $data['case_instance_business_key_like'] ?? null;
        ...
        $this->container['case_definition_name_like'] = $data['case_definition_name_like'] ?? null;
        ...
        $this->container['without_tenant_id'] = $data['without_tenant_id'] ?? false;
        $this->container['assignee'] = $data['assignee'] ?? null;
        $this->container['assignee_expression'] = $data['assignee_expression'] ?? null;
        $this->container['assignee_like'] = $data['assignee_like'] ?? null;
        $this->container['assignee_like_expression'] = $data['assignee_like_expression'] ?? null;
        $this->container['assignee_in'] = $data['assignee_in'] ?? null;
        $this->container['owner'] = $data['owner'] ?? null;
        $this->container['owner_expression'] = $data['owner_expression'] ?? null;
        $this->container['candidate_group'] = $data['candidate_group'] ?? null;
        $this->container['candidate_group_expression'] = $data['candidate_group_expression'] ?? null;
        $this->container['candidate_user'] = $data['candidate_user'] ?? null;
        $this->container['candidate_user_expression'] = $data['candidate_user_expression'] ?? null;
        $this->container['include_assigned_tasks'] = $data['include_assigned_tasks'] ?? false;
        $this->container['involved_user'] = $data['involved_user'] ?? null;
        $this->container['involved_user_expression'] = $data['involved_user_expression'] ?? null;
        $this->container['assigned'] = $data['assigned'] ?? false;
        $this->container['unassigned'] = $data['unassigned'] ?? false;
        ...
        $this->container['task_definition_key_like'] = $data['task_definition_key_like'] ?? null;
        $this->container['name'] = $data['name'] ?? null;
        $this->container['name_not_equal'] = $data['name_not_equal'] ?? null;
        $this->container['name_like'] = $data['name_like'] ?? null;
        $this->container['name_not_like'] = $data['name_not_like'] ?? null;
        $this->container['description'] = $data['description'] ?? null;
        $this->container['description_like'] = $data['description_like'] ?? null;
        $this->container['priority'] = $data['priority'] ?? null;
        $this->container['max_priority'] = $data['max_priority'] ?? null;
        $this->container['min_priority'] = $data['min_priority'] ?? null;
        $this->container['due_date'] = $data['due_date'] ?? null;
        $this->container['due_date_expression'] = $data['due_date_expression'] ?? null;
        $this->container['due_after'] = $data['due_after'] ?? null;
        $this->container['due_after_expression'] = $data['due_after_expression'] ?? null;
        $this->container['due_before'] = $data['due_before'] ?? null;
        $this->container['due_before_expression'] = $data['due_before_expression'] ?? null;
        $this->container['without_due_date'] = $data['without_due_date'] ?? false;
        $this->container['follow_up_date'] = $data['follow_up_date'] ?? null;
        $this->container['follow_up_date_expression'] = $data['follow_up_date_expression'] ?? null;
        $this->container['follow_up_after'] = $data['follow_up_after'] ?? null;
        $this->container['follow_up_after_expression'] = $data['follow_up_after_expression'] ?? null;
        $this->container['follow_up_before'] = $data['follow_up_before'] ?? null;
        $this->container['follow_up_before_expression'] = $data['follow_up_before_expression'] ?? null;
        $this->container['follow_up_before_or_not_existent'] = $data['follow_up_before_or_not_existent'] ?? null;
        $this->container['follow_up_before_or_not_existent_expression'] = $data['follow_up_before_or_not_existent_expression'] ?? null;
        $this->container['created_on'] = $data['created_on'] ?? null;
        $this->container['created_on_expression'] = $data['created_on_expression'] ?? null;
        $this->container['created_after'] = $data['created_after'] ?? null;
        $this->container['created_after_expression'] = $data['created_after_expression'] ?? null;
        $this->container['created_before'] = $data['created_before'] ?? null;
        $this->container['created_before_expression'] = $data['created_before_expression'] ?? null;
        $this->container['delegation_state'] = $data['delegation_state'] ?? null;
        $this->container['candidate_groups'] = $data['candidate_groups'] ?? null;
        $this->container['candidate_groups_expression'] = $data['candidate_groups_expression'] ?? null;
        $this->container['with_candidate_groups'] = $data['with_candidate_groups'] ?? false;
        $this->container['without_candidate_groups'] = $data['without_candidate_groups'] ?? false;
        $this->container['with_candidate_users'] = $data['with_candidate_users'] ?? false;
        $this->container['without_candidate_users'] = $data['without_candidate_users'] ?? false;
        $this->container['active'] = $data['active'] ?? false;
        $this->container['suspended'] = $data['suspended'] ?? false;
        $this->container['task_variables'] = $data['task_variables'] ?? null;
        $this->container['process_variables'] = $data['process_variables'] ?? null;
        $this->container['case_instance_variables'] = $data['case_instance_variables'] ?? null;
        $this->container['variable_names_ignore_case'] = $data['variable_names_ignore_case'] ?? false;
        $this->container['variable_values_ignore_case'] = $data['variable_values_ignore_case'] ?? false;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['delegation_state']) && !in_array($this->container['delegation_state'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'delegation_state', must be one of '%s'",
                $this->container['delegation_state'],
     ...
     *
     * @param string|null $assignee_expression Restrict to tasks that the user described by the given expression is assigned to. See the [user guide](https://docs.camunda.org/manual/7.15/user-guide/process-engine/expression-language/#internal-context-functions)  for more information on available functions.
     *
     * @return self
     */
     ...
     *
     * @param string|null $owner_expression Restrict to tasks that the user described by the given expression owns. See the  [user guide](https://docs.camunda.org/manual/7.15/user-guide/process-engine/expression-language/#internal-context-functions)  for more information on available functions.
     *
     * @return self
     */
     ...
     *
     * @param string|null $candidate_group_expression Only include tasks that are offered to the group described by the given expression.  See the  [user guide](https://docs.camunda.org/manual/7.15/user-guide/process-engine/expression-language/#internal-context-functions)  for more information on available functions.
     *
     * @return self
     */
     ...
     *
     * @param string|null $candidate_user_expression Only include tasks that are offered to the user described by the given expression.  See the  [user guide](https://docs.camunda.org/manual/7.15/user-guide/process-engine/expression-language/#internal-context-functions)  for more information on available functions.
     *
     * @return self
     */
     ...
     * Sets due_date
     *
     * @param \DateTime|null $due_date Restrict to tasks that are due on the given date. By [default](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.546+0200`.
     *
     * @return self
     */
     ...
     * Sets due_after
     *
     * @param \DateTime|null $due_after Restrict to tasks that are due after the given date. By [default](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.435+0200`.
     *
     * @return self
     */
     ...
     * Sets due_before
     *
     * @param \DateTime|null $due_before Restrict to tasks that are due before the given date. By [default](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.243+0200`.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $without_due_date Only include tasks which have no due date. Value may only be `true`,  as `false` is the default behavior.
     *
     * @return self
     */
     ...
     * Sets follow_up_date
     *
     * @param \DateTime|null $follow_up_date Restrict to tasks that have a followUp date on the given date. By [default](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.342+0200`.
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $follow_up_after Restrict to tasks that have a followUp date after the given date. By [default](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.542+0200`.
     *
     * @return self
     */
     ...
     *
     * @param string|null $follow_up_before Restrict to tasks that have a followUp date before the given date. By [default](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.234+0200`.
     *
     * @return self
     */
     ...
     * Sets created_on
     *
     * @param \DateTime|null $created_on Restrict to tasks that were created on the given date. By [default](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.324+0200`.
     *
     * @return self
     */
     ...
     * Sets created_after
     *
     * @param \DateTime|null $created_after Restrict to tasks that were created after the given date. By [default](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.342+0200`.
     *
     * @return self
     */
     ...
     * Sets created_before
     *
     * @param \DateTime|null $created_before Restrict to tasks that were created before the given date. By [default](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.332+0200`.
     *
     * @return self
     */
     ...
     * Gets task_variables
     *
     * @return \NookeST\Camunda\Model\VariableQueryParameterDto[]|null
     */
     ...
     * Sets task_variables
     *
     * @param \NookeST\Camunda\Model\VariableQueryParameterDto[]|null $task_variables A JSON array to only include tasks that have variables with certain values. The array consists of JSON objects with three properties `name`, `operator` and `value`. `name` is the variable name, `operator` is the comparison operator to be used and `value` the variable value. `value` may be of type `String`, `Number` or `Boolean`.  Valid `operator` values are: `eq` - equal to; `neq` - not equal to; `gt` - greater than; `gteq` - greater than or equal to; `lt` - lower than; `lteq` - lower than or equal to; `like`. `key` and `value` may not contain underscore or comma characters.
     *
     * @return self
     */
     ...
     *
     * @param \NookeST\Camunda\Model\VariableQueryParameterDto[]|null $process_variables A JSON array to only include tasks that belong to a process instance with variables with certain values. The array consists of JSON objects with three properties `name`, `operator` and `value`. `name` is the variable name, `operator` is the comparison operator to be used and `value` the variable value. `value` may be of type `String`, `Number` or `Boolean`.  Valid `operator` values are: `eq` - equal to; `neq` - not equal to; `gt` - greater than; `gteq` - greater than or equal to; `lt` - lower than; `lteq` - lower than or equal to; `like`; `notLike`. `key` and `value` may not contain underscore or comma characters.
     *
     * @return self
     */
     ...
     *
     * @param \NookeST\Camunda\Model\VariableQueryParameterDto[]|null $case_instance_variables A JSON array to only include tasks that belong to a case instance with variables with certain values. The array consists of JSON objects with three properties `name`, `operator` and `value`. `name` is the variable name, `operator` is the comparison operator to be used and `value` the variable value. `value` may be of type `String`, `Number` or `Boolean`.  Valid `operator` values are: `eq` - equal to; `neq` - not equal to; `gt` - greater than; `gteq` - greater than or equal to; `lt` - lower than; `lteq` - lower than or equal to; `like`. `key` and `value` may not contain underscore or comma characters.
     *
     * @return self
     */
     ...
     * Gets or_queries
     *
     * @return \NookeST\Camunda\Model\TaskQueryDto[]|null
     */
     ...
     * Gets sorting
     *
     * @return \NookeST\Camunda\Model\TaskQueryDtoSorting[]|null
     */
     ...
     * Sets sorting
     *
     * @param \NookeST\Camunda\Model\TaskQueryDtoSorting[]|null $sorting Apply sorting of the result
     *
     * @return self
     */
