...
class MessageCorrelationResultWithVariableDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'result_type' => 'string',
        'process_instance' => '\NookeST\Camunda\Model\ProcessInstanceDto',
        'execution' => '\NookeST\Camunda\Model\ExecutionDto',
     ...
     *
     * @return \NookeST\Camunda\Model\ProcessInstanceDto|null
     */
     ...
     *
     * @param \NookeST\Camunda\Model\ProcessInstanceDto|null $process_instance process_instance
     *
     * @return self
     */
     ...
     * Gets execution
     *
     * @return \NookeST\Camunda\Model\ExecutionDto|null
     */
     ...
     * Sets execution
     *
     * @param \NookeST\Camunda\Model\ExecutionDto|null $execution execution
     *
     * @return self
     */
     ...
     * Sets variables
     *
     * @param array<string,\NookeST\Camunda\Model\VariableValueDto>|null $variables This property is returned if the `variablesInResultEnabled` is set to `true`. Contains a list of the process variables.
     *
     * @return self
     */
