...
/**
 * SetVariablesAsyncDto Class Doc Comment
 *
 * @category Class
 * @package  NookeST\Camunda
 * @author   OpenAPI Generator team
 ...
 */
class SetVariablesAsyncDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SetVariablesAsyncDto';
     ...
     *
     * @param string[]|null $process_instance_ids A list of process instance ids that define a group of process instances to which the operation will set variables.  Please note that if `processInstanceIds`, `processInstanceQuery` and `historicProcessInstanceQuery` are defined, the resulting operation will be performed on the union of these sets.
     *
     * @return self
     */
     ...
     * Sets variables
     *
     * @param array<string,\NookeST\Camunda\Model\VariableValueDto>|null $variables A variables the operation will set in the root scope of the process instances.
     *
     * @return self
     */
