 ...
 */
class HistoricActivityInstanceDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HistoricActivityInstanceDto';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['called_process_instance_id'] = $data['called_process_instance_id'] ?? null;
        $this->container['called_case_instance_id'] = $data['called_case_instance_id'] ?? null;
     ...
     * Sets activity_id
     *
     * @param string|null $activity_id The id of the activity that this object is an instance of.
     *
     * @return self
     */
     ...
     * Sets activity_name
     *
     * @param string|null $activity_name The name of the activity that this object is an instance of.
     *
     * @return self
     */
     ...
     * Sets activity_type
     *
     * @param string|null $activity_type The type of the activity that this object is an instance of.
     *
     * @return self
     */
     ...
     *
     * @param string|null $process_definition_key The key of the process definition that this activity instance belongs to.
     *
     * @return self
     */
     ...
     *
     * @param string|null $process_definition_id The id of the process definition that this activity instance belongs to.
     *
     * @return self
     */
     ...
     *
     * @param string|null $process_instance_id The id of the process instance that this activity instance belongs to.
     *
     * @return self
     */
     ...
     * Sets execution_id
     *
     * @param string|null $execution_id The id of the execution that executed this activity instance.
     *
     * @return self
     */
     ...
     * Sets task_id
     *
     * @param string|null $task_id The id of the task that is associated to this activity instance. Is only set if the activity is a user task.
     *
     * @return self
     */
     ...
     * Sets assignee
     *
     * @param string|null $assignee The assignee of the task that is associated to this activity instance. Is only set if the activity is a user task.
     *
     * @return self
     */
     ...
     *
     * @param string|null $called_process_instance_id The id of the called process instance. Is only set if the activity is a call activity and the called instance a process instance.
     *
     * @return self
     */
     ...
     *
     * @param string|null $called_case_instance_id The id of the called case instance. Is only set if the activity is a call activity and the called instance a case instance.
     *
     * @return self
     */
     ...
     * Sets start_time
     *
     * @param \DateTime|null $start_time The time the instance was started. By [default](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.000+0200`.
     *
     * @return self
     */
     ...
     * Sets end_time
     *
     * @param \DateTime|null $end_time The time the instance ended. By [default](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.000+0200`.
     *
     * @return self
     */
     ...
     * Sets canceled
     *
     * @param bool|null $canceled If `true`, this activity instance is canceled.
     *
     * @return self
     */
     ...
     * Sets complete_scope
     *
     * @param bool|null $complete_scope If `true`, this activity instance did complete a BPMN 2.0 scope.
     *
     * @return self
     */
     ...
     * Sets tenant_id
     *
     * @param string|null $tenant_id The tenant id of the activity instance.
     *
     * @return self
     */
     ...
     * Sets removal_time
     *
     * @param \DateTime|null $removal_time The time after which the activity instance should be removed by the History Cleanup job. By [default](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.000+0200`.
     *
     * @return self
     */
     ...
     *
     * @param string|null $root_process_instance_id The process instance id of the root process instance that initiated the process containing this activity instance.
     *
     * @return self
     */
