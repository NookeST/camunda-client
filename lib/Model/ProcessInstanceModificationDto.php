...
class ProcessInstanceModificationDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'instructions' => '\NookeST\Camunda\Model\ProcessInstanceModificationInstructionDto[]',
        'annotation' => 'string'
    ];
     ...
     *
     * @param bool|null $skip_io_mappings Skip execution of [input/output variable mappings](https://docs.camunda.org/manual/7.15/user-guide/process-engine/variables/#input-output-variable-mapping) for activities that are started or ended as part of this request.
     *
     * @return self
     */
     ...
     * Sets instructions
     *
     * @param \NookeST\Camunda\Model\ProcessInstanceModificationInstructionDto[]|null $instructions JSON array of modification instructions. The instructions are executed in the order they are in.
     *
     * @return self
     */
