 ...
 */
class HistoricProcessInstanceQueryDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'variables' => '\NookeST\Camunda\Model\VariableQueryParameterDto[]',
        'variable_names_ignore_case' => 'bool',
        'variable_values_ignore_case' => 'bool',
        'or_queries' => '\NookeST\Camunda\Model\HistoricProcessInstanceQueryDto[]',
        'sorting' => '\NookeST\Camunda\Model\HistoricProcessInstanceQueryDtoSorting[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['process_definition_key_not_in'] = $data['process_definition_key_not_in'] ?? null;
        ...
        $this->container['root_process_instances'] = $data['root_process_instances'] ?? null;
        $this->container['finished'] = $data['finished'] ?? null;
        $this->container['unfinished'] = $data['unfinished'] ?? null;
        $this->container['with_incidents'] = $data['with_incidents'] ?? null;
        $this->container['with_root_incidents'] = $data['with_root_incidents'] ?? null;
        $this->container['incident_type'] = $data['incident_type'] ?? null;
        $this->container['incident_status'] = $data['incident_status'] ?? null;
        ...
        $this->container['executed_activity_after'] = $data['executed_activity_after'] ?? null;
        $this->container['executed_activity_before'] = $data['executed_activity_before'] ?? null;
        $this->container['executed_job_after'] = $data['executed_job_after'] ?? null;
        $this->container['executed_job_before'] = $data['executed_job_before'] ?? null;
        $this->container['started_by'] = $data['started_by'] ?? null;
        $this->container['super_process_instance_id'] = $data['super_process_instance_id'] ?? null;
        $this->container['sub_process_instance_id'] = $data['sub_process_instance_id'] ?? null;
        $this->container['super_case_instance_id'] = $data['super_case_instance_id'] ?? null;
        $this->container['sub_case_instance_id'] = $data['sub_case_instance_id'] ?? null;
        ...
        $this->container['executed_activity_id_in'] = $data['executed_activity_id_in'] ?? null;
        $this->container['active_activity_id_in'] = $data['active_activity_id_in'] ?? null;
        $this->container['active'] = $data['active'] ?? null;
        $this->container['suspended'] = $data['suspended'] ?? null;
        $this->container['completed'] = $data['completed'] ?? null;
        $this->container['externally_terminated'] = $data['externally_terminated'] ?? null;
        $this->container['internally_terminated'] = $data['internally_terminated'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['incident_status']) && !in_array($this->container['incident_status'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'incident_status', must be one of '%s'",
                $this->container['incident_status'],
     ...
     *
     * @param string[]|null $process_instance_ids Filter by process instance ids. Must be a JSON array of `Strings`.
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $process_definition_key_not_in Exclude instances that belong to a set of process definitions. Must be a JSON array of `Strings`.
     *
     * @return self
     */
     ...
     * Sets finished
     *
     * @param bool|null $finished Only include finished process instances. This flag includes all process instances that are completed or terminated. Value may only be `true`, as `false` is the default behavior.
     *
     * @return self
     */
     ...
     * Sets incident_type
     *
     * @param string|null $incident_type Filter by the incident type. See the [User Guide](https://docs.camunda.org/manual/7.15/user-guide/process-engine/incidents/#incident-types) for a list of incident types.
     *
     * @return self
     */
     ...
     * Sets started_before
     *
     * @param \DateTime|null $started_before Restrict to instances that were started before the given date. By [default](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.000+0200`.
     *
     * @return self
     */
     ...
     * Sets started_after
     *
     * @param \DateTime|null $started_after Restrict to instances that were started after the given date. By [default](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.000+0200`.
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $finished_before Restrict to instances that were finished before the given date. By [default](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.000+0200`.
     *
     * @return self
     */
     ...
     * Sets finished_after
     *
     * @param \DateTime|null $finished_after Restrict to instances that were finished after the given date. By [default](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.000+0200`.
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $executed_activity_after Restrict to instances that executed an activity after the given date (inclusive). By [default](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.000+0200`.
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $executed_activity_before Restrict to instances that executed an activity before the given date (inclusive). By [default](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.000+0200`.
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $executed_job_after Restrict to instances that executed an job after the given date (inclusive). By [default](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.000+0200`.
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $executed_job_before Restrict to instances that executed an job before the given date (inclusive). By [default](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.000+0200`.
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $executed_activity_id_in Restrict to instances that executed an activity with one of given ids. Must be a JSON array of `Strings`
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $active_activity_id_in Restrict to instances that have an active activity with one of given ids. Must be a JSON array of `Strings`
     *
     * @return self
     */
     ...
     * Sets variables
     *
     * @param \NookeST\Camunda\Model\VariableQueryParameterDto[]|null $variables A JSON array to only include process instances that have/had variables with certain values. The array consists of objects with the three properties `name`, `operator` and `value`. `name` (`String`) is the variable name, `operator` (`String`) is the comparison operator to be used and `value` the variable value.  Value may be `String`, `Number` or `Boolean`.  Valid operator values are: `eq` - equal to; `neq` - not equal to; `gt` - greater than; `gteq` - greater than or equal to; `lt` - lower than; `lteq` - lower than or equal to; `like`.
     *
     * @return self
     */
     ...
     * Gets sorting
     *
     * @return \NookeST\Camunda\Model\HistoricProcessInstanceQueryDtoSorting[]|null
     */
     ...
     * Sets sorting
     *
     * @param \NookeST\Camunda\Model\HistoricProcessInstanceQueryDtoSorting[]|null $sorting Apply sorting of the result
     *
     * @return self
     */
