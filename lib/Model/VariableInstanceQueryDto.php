...
class VariableInstanceQueryDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'tenant_id_in' => 'string[]',
        'variable_values' => '\NookeST\Camunda\Model\VariableQueryParameterDto[]',
        'variable_names_ignore_case' => 'bool',
        'variable_values_ignore_case' => 'bool',
        'sorting' => '\NookeST\Camunda\Model\VariableInstanceQueryDtoSorting[]'
    ];
     ...
     *
     * @param \NookeST\Camunda\Model\VariableQueryParameterDto[]|null $variable_values An array to only include variable instances that have the certain values. The array consists of objects with the three properties `name`, `operator` and `value`. `name (String)` is the variable name, `operator (String)` is the comparison operator to be used and `value` the variable value. `value` may be `String`, `Number` or `Boolean`.  Valid operator values are: `eq` - equal to; `neq` - not equal to; `gt` - greater than; `gteq` - greater than or equal to; `lt` - lower than; `lteq` - lower than or equal to; `like`
     *
     * @return self
     */
     ...
     * Gets sorting
     *
     * @return \NookeST\Camunda\Model\VariableInstanceQueryDtoSorting[]|null
     */
     ...
     * Sets sorting
     *
     * @param \NookeST\Camunda\Model\VariableInstanceQueryDtoSorting[]|null $sorting An array of criteria to sort the result by. Each element of the array is an object that specifies one ordering.                       The position in the array identifies the rank of an ordering, i.e., whether it is primary, secondary, etc.                       Sorting has no effect for `count` endpoints
     *
     * @return self
     */
