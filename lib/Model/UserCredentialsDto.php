 ...
 */
class UserCredentialsDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserCredentialsDto';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['authenticated_user_password'] = $data['authenticated_user_password'] ?? null;
    }
     ...
     * Sets password
     *
     * @param string|null $password The users new password.
     *
     * @return self
     */
     ...
     *
     * @param string|null $authenticated_user_password The password of the authenticated user who changes the password of the user (i.e., the user with passed id as path parameter).
     *
     * @return self
     */
