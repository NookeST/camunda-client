...
class FetchExternalTasksDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'topics' => '\NookeST\Camunda\Model\FetchExternalTaskTopicDto[]'
    ];
     ...
     *
     * @param int|null $async_response_timeout The [Long Polling](https://docs.camunda.org/manual/7.15/user-guide/process-engine/external-tasks/#long-polling-to-fetch-and-lock-external-tasks) timeout in milliseconds.  **Note:** The value cannot be set larger than 1.800.000 milliseconds (corresponds to 30 minutes).
     *
     * @return self
     */
     ...
     * Gets topics
     *
     * @return \NookeST\Camunda\Model\FetchExternalTaskTopicDto[]|null
     */
     ...
     * Sets topics
     *
     * @param \NookeST\Camunda\Model\FetchExternalTaskTopicDto[]|null $topics A JSON array of topic objects for which external tasks should be fetched. The returned tasks may be arbitrarily distributed among these topics. Each topic object has the following properties:
     *
     * @return self
     */
