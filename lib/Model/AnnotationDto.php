 ...
 */
class AnnotationDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AnnotationDto';
     ...
     * Sets annotation
     *
     * @param string|null $annotation The annotation value to put.
     *
     * @return self
     */
