...
class TaskDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['form_key'] = $data['form_key'] ?? null;
     ...
     * Sets created
     *
     * @param \DateTime|null $created The date the task was created on. [Default format](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/) `yyyy-MM-dd'T'HH:mm:ss.SSSZ`.
     *
     * @return self
     */
     ...
     * Sets due
     *
     * @param \DateTime|null $due The task's due date. [Default format](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/) `yyyy-MM-dd'T'HH:mm:ss.SSSZ`.
     *
     * @return self
     */
     ...
     * Sets follow_up
     *
     * @param \DateTime|null $follow_up The follow-up date for the task. [Default format](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/) `yyyy-MM-dd'T'HH:mm:ss.SSSZ`.
     *
     * @return self
     */
