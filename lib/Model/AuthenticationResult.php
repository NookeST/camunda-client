...
class AuthenticationResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['authenticated_user'] = $data['authenticated_user'] ?? null;
        $this->container['is_authenticated'] = $data['is_authenticated'] ?? null;
     ...
     *
     * @param string|null $authenticated_user An id of authenticated user.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $is_authenticated A flag indicating if user is authenticated.
     *
     * @return self
     */
     ...
     * Sets tenants
     *
     * @param string[]|null $tenants Will be null.
     *
     * @return self
     */
     ...
     * Sets groups
     *
     * @param string[]|null $groups Will be null.
     *
     * @return self
     */
