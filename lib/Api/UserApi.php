...
class UserApi
{
     ...
     * @return \NookeST\Camunda\Model\ResourceOptionsDto
     */
     ...
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \NookeST\Camunda\Model\ResourceOptionsDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function availableOperationsWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\NookeST\Camunda\Model\ResourceOptionsDto' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\NookeST\Camunda\Model\ResourceOptionsDto', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\NookeST\Camunda\Model\ResourceOptionsDto';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\NookeST\Camunda\Model\ResourceOptionsDto',
     ...
     * Create
     *
     * @param  \NookeST\Camunda\Model\UserDto $user_dto user_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * Create
     *
     * @param  \NookeST\Camunda\Model\UserDto $user_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NookeST\Camunda\Model\UserProfileDto|\NookeST\Camunda\Model\ExceptionDto
     */
     ...
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \NookeST\Camunda\Model\UserProfileDto|\NookeST\Camunda\Model\ExceptionDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getUserProfileWithHttpInfo($id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\NookeST\Camunda\Model\UserProfileDto' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\NookeST\Camunda\Model\UserProfileDto', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
            ...
            $returnType = '\NookeST\Camunda\Model\UserProfileDto';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\NookeST\Camunda\Model\UserProfileDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \NookeST\Camunda\Model\UserCredentialsDto $user_credentials_dto user_credentials_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return mixed|mixed|mixed|mixed|\NookeST\Camunda\Model\ExceptionDto
     */
     ...
     * @param  string $password The users new password. (required)
     * @param  string $authenticated_user_password The password of the authenticated user who changes the password of the user (i.e., the user with passed id as path parameter). (required)
     * @param  \NookeST\Camunda\Model\UserCredentialsDto $user_credentials_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of mixed|mixed|mixed|mixed|\NookeST\Camunda\Model\ExceptionDto, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  \NookeST\Camunda\Model\UserProfileDto $user_profile_dto user_profile_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $id The id of the user. (required)
     * @param  \NookeST\Camunda\Model\UserProfileDto $user_profile_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
