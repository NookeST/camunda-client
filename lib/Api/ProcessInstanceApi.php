...
class ProcessInstanceApi
{
     ...
     *
     * @param  \NookeST\Camunda\Model\DeleteProcessInstancesDto $delete_process_instances_dto **Unallowed property**: &#x60;processInstanceQuery&#x60; (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NookeST\Camunda\Model\BatchDto|\NookeST\Camunda\Model\ExceptionDto
     */
     ...
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \NookeST\Camunda\Model\BatchDto|\NookeST\Camunda\Model\ExceptionDto, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     */
    public function deleteAsyncHistoricQueryBasedRequest($delete_process_instances_dto = null)
    {
        ...
        if (isset($delete_process_instances_dto)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($delete_process_instances_dto));
            } else {
                $httpBody = $delete_process_instances_dto;
            }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteProcessInstanceRequest($id, $skip_custom_listeners = false, $skip_io_mappings = false, $skip_subprocesses = false, $fail_if_not_exists = true)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteProcessInstanceVariableRequest($id, $var_name)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * Delete Async (POST)
     *
     * @param  \NookeST\Camunda\Model\DeleteProcessInstancesDto $delete_process_instances_dto **Unallowed property**: &#x60;historicProcessInstanceQuery&#x60; (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NookeST\Camunda\Model\BatchDto|\NookeST\Camunda\Model\ExceptionDto
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteProcessInstancesAsyncOperationRequest($delete_process_instances_dto = null)
    {
     ...
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NookeST\Camunda\Model\ActivityInstanceDto|\NookeST\Camunda\Model\ExceptionDto
     */
     ...
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \NookeST\Camunda\Model\ActivityInstanceDto|\NookeST\Camunda\Model\ExceptionDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getActivityInstanceTreeWithHttpInfo($id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\NookeST\Camunda\Model\ActivityInstanceDto' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\NookeST\Camunda\Model\ActivityInstanceDto', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 500:
            ...
            $returnType = '\NookeST\Camunda\Model\ActivityInstanceDto';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\NookeST\Camunda\Model\ActivityInstanceDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getActivityInstanceTreeRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NookeST\Camunda\Model\ProcessInstanceDto|\NookeST\Camunda\Model\ExceptionDto
     */
     ...
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \NookeST\Camunda\Model\ProcessInstanceDto|\NookeST\Camunda\Model\ExceptionDto, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getProcessInstanceRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NookeST\Camunda\Model\VariableValueDto|\NookeST\Camunda\Model\ExceptionDto
     */
     ...
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \NookeST\Camunda\Model\VariableValueDto|\NookeST\Camunda\Model\ExceptionDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getProcessInstanceVariableWithHttpInfo($id, $var_name, $deserialize_value = true)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\NookeST\Camunda\Model\VariableValueDto' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\NookeST\Camunda\Model\VariableValueDto', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\NookeST\Camunda\Model\VariableValueDto';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\NookeST\Camunda\Model\VariableValueDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getProcessInstanceVariableRequest($id, $var_name, $deserialize_value = true)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getProcessInstanceVariableBinaryRequest($id, $var_name)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getProcessInstanceVariablesRequest($id, $deserialize_values = true)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getProcessInstancesRequest($sort_by = null, $sort_order = null, $first_result = null, $max_results = null, $process_instance_ids = null, $business_key = null, $business_key_like = null, $case_instance_id = null, $process_definition_id = null, $process_definition_key = null, $process_definition_key_in = null, $process_definition_key_not_in = null, $deployment_id = null, $super_process_instance = null, $sub_process_instance = null, $super_case_instance = null, $sub_case_instance = null, $active = false, $suspended = false, $with_incident = false, $incident_id = null, $incident_type = null, $incident_message = null, $incident_message_like = null, $tenant_id_in = null, $without_tenant_id = false, $process_definition_without_tenant_id = false, $activity_id_in = null, $root_process_instances = false, $leaf_process_instances = false, $variables = null, $variable_names_ignore_case = false, $variable_values_ignore_case = false)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getProcessInstancesCountRequest($process_instance_ids = null, $business_key = null, $business_key_like = null, $case_instance_id = null, $process_definition_id = null, $process_definition_key = null, $process_definition_key_in = null, $process_definition_key_not_in = null, $deployment_id = null, $super_process_instance = null, $sub_process_instance = null, $super_case_instance = null, $sub_case_instance = null, $active = false, $suspended = false, $with_incident = false, $incident_id = null, $incident_type = null, $incident_message = null, $incident_message_like = null, $tenant_id_in = null, $without_tenant_id = false, $process_definition_without_tenant_id = false, $activity_id_in = null, $root_process_instances = false, $leaf_process_instances = false, $variables = null, $variable_names_ignore_case = false, $variable_values_ignore_case = false)
    {
     ...
     * @param  \NookeST\Camunda\Model\ProcessInstanceModificationDto $process_instance_modification_dto process_instance_modification_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $id The id of the process instance to modify. (required)
     * @param  \NookeST\Camunda\Model\ProcessInstanceModificationDto $process_instance_modification_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function modifyProcessInstanceRequest($id, $process_instance_modification_dto = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($process_instance_modification_dto)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($process_instance_modification_dto));
            } else {
                $httpBody = $process_instance_modification_dto;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NookeST\Camunda\Model\BatchDto|\NookeST\Camunda\Model\ExceptionDto|\NookeST\Camunda\Model\AuthorizationExceptionDto|\NookeST\Camunda\Model\ExceptionDto
     */
     ...
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \NookeST\Camunda\Model\BatchDto|\NookeST\Camunda\Model\ExceptionDto|\NookeST\Camunda\Model\AuthorizationExceptionDto|\NookeST\Camunda\Model\ExceptionDto, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function modifyProcessInstanceAsyncOperationRequest($id, $process_instance_modification_dto = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @param  \NookeST\Camunda\Model\PatchVariablesDto $patch_variables_dto patch_variables_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $id The id of the process instance to set variables for. (required)
     * @param  \NookeST\Camunda\Model\PatchVariablesDto $patch_variables_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function modifyProcessInstanceVariablesRequest($id, $patch_variables_dto = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @param  int $first_result Pagination of results. Specifies the index of the first result to return. (optional)
     * @param  int $max_results Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left. (optional)
     * @param  \NookeST\Camunda\Model\ProcessInstanceQueryDto $process_instance_query_dto process_instance_query_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NookeST\Camunda\Model\ProcessInstanceDto[]|\NookeST\Camunda\Model\ExceptionDto
     ...
     * @param  int $first_result Pagination of results. Specifies the index of the first result to return. (optional)
     * @param  int $max_results Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left. (optional)
     * @param  \NookeST\Camunda\Model\ProcessInstanceQueryDto $process_instance_query_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \NookeST\Camunda\Model\ProcessInstanceDto[]|\NookeST\Camunda\Model\ExceptionDto, HTTP status code, HTTP response headers (array of strings)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function queryProcessInstancesRequest($first_result = null, $max_results = null, $process_instance_query_dto = null)
    {
        ...
        if (isset($process_instance_query_dto)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($process_instance_query_dto));
            } else {
                $httpBody = $process_instance_query_dto;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function queryProcessInstancesCountRequest($process_instance_query_dto = null)
    {
     ...
     * @param  \NookeST\Camunda\Model\VariableValueDto $variable_value_dto variable_value_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * @param  string $id The id of the process instance to set the variable for. (required)
     * @param  string $var_name The name of the variable to set. (required)
     * @param  \NookeST\Camunda\Model\VariableValueDto $variable_value_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function setProcessInstanceVariableRequest($id, $var_name, $variable_value_dto = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function setProcessInstanceVariableBinaryRequest($id, $var_name, $data = null, $value_type = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     *
     * @param  \NookeST\Camunda\Model\SetJobRetriesByProcessDto $set_job_retries_by_process_dto Please note that if both processInstances and processInstanceQuery are provided, then the resulting execution will be performed on the union of these sets. **Unallowed property**: &#x60;historicProcessInstanceQuery&#x60; (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NookeST\Camunda\Model\BatchDto|\NookeST\Camunda\Model\ExceptionDto
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function setRetriesByProcessRequest($set_job_retries_by_process_dto = null)
    {
        ...
        if (isset($set_job_retries_by_process_dto)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($set_job_retries_by_process_dto));
            } else {
                $httpBody = $set_job_retries_by_process_dto;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     *
     * @param  \NookeST\Camunda\Model\SetJobRetriesByProcessDto $set_job_retries_by_process_dto Please note that if both processInstances and historicProcessInstanceQuery are provided, then the resulting execution will be performed on the union of these sets. **Unallowed property**: &#x60;processInstanceQuery&#x60; (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NookeST\Camunda\Model\BatchDto|\NookeST\Camunda\Model\ExceptionDto
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function setRetriesByProcessHistoricQueryBasedRequest($set_job_retries_by_process_dto = null)
    {
     ...
     *
     * @param  \NookeST\Camunda\Model\SetVariablesAsyncDto $set_variables_async_dto set_variables_async_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NookeST\Camunda\Model\BatchDto|\NookeST\Camunda\Model\ExceptionDto|\NookeST\Camunda\Model\AuthorizationExceptionDto
     */
    public function setVariablesAsyncOperation($set_variables_async_dto = null)
    {
        list($response) = $this->setVariablesAsyncOperationWithHttpInfo($set_variables_async_dto);
        return $response;
    }
     ...
     * Set Variables Async (POST)
     *
     * @param  \NookeST\Camunda\Model\SetVariablesAsyncDto $set_variables_async_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \NookeST\Camunda\Model\BatchDto|\NookeST\Camunda\Model\ExceptionDto|\NookeST\Camunda\Model\AuthorizationExceptionDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function setVariablesAsyncOperationWithHttpInfo($set_variables_async_dto = null)
    {
        $request = $this->setVariablesAsyncOperationRequest($set_variables_async_dto);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setVariablesAsyncOperationAsync($set_variables_async_dto = null)
    {
        return $this->setVariablesAsyncOperationAsyncWithHttpInfo($set_variables_async_dto)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setVariablesAsyncOperationAsyncWithHttpInfo($set_variables_async_dto = null)
    {
        $returnType = '\NookeST\Camunda\Model\BatchDto';
        $request = $this->setVariablesAsyncOperationRequest($set_variables_async_dto);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function setVariablesAsyncOperationRequest($set_variables_async_dto = null)
    {
        ...
        // for model (json/xml)
        if (isset($set_variables_async_dto)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($set_variables_async_dto));
            } else {
                $httpBody = $set_variables_async_dto;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     *
     * @param  \NookeST\Camunda\Model\ProcessInstanceSuspensionStateDto $process_instance_suspension_state_dto process_instance_suspension_state_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * Activate/Suspend In Group
     *
     * @param  \NookeST\Camunda\Model\ProcessInstanceSuspensionStateDto $process_instance_suspension_state_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateSuspensionStateRequest($process_instance_suspension_state_dto = null)
    {
        ...
        if (isset($process_instance_suspension_state_dto)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($process_instance_suspension_state_dto));
            } else {
                $httpBody = $process_instance_suspension_state_dto;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     *
     * @param  \NookeST\Camunda\Model\ProcessInstanceSuspensionStateAsyncDto $process_instance_suspension_state_async_dto process_instance_suspension_state_async_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NookeST\Camunda\Model\BatchDto|\NookeST\Camunda\Model\ExceptionDto
     ...
     * Activate/Suspend In Batch
     *
     * @param  \NookeST\Camunda\Model\ProcessInstanceSuspensionStateAsyncDto $process_instance_suspension_state_async_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \NookeST\Camunda\Model\BatchDto|\NookeST\Camunda\Model\ExceptionDto, HTTP status code, HTTP response headers (array of strings)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateSuspensionStateAsyncOperationRequest($process_instance_suspension_state_async_dto = null)
    {
        ...
        if (isset($process_instance_suspension_state_async_dto)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($process_instance_suspension_state_async_dto));
            } else {
                $httpBody = $process_instance_suspension_state_async_dto;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @param  \NookeST\Camunda\Model\SuspensionStateDto $suspension_state_dto suspension_state_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $id The id of the process instance to activate or suspend. (required)
     * @param  \NookeST\Camunda\Model\SuspensionStateDto $suspension_state_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateSuspensionStateByIdRequest($id, $suspension_state_dto = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
