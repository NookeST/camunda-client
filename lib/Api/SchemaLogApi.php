...
class SchemaLogApi
{
     ...
     * @return \NookeST\Camunda\Model\SchemaLogEntryDto[]
     */
     ...
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \NookeST\Camunda\Model\SchemaLogEntryDto[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getSchemaLogWithHttpInfo($version = null, $first_result = null, $max_results = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\NookeST\Camunda\Model\SchemaLogEntryDto[]' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\NookeST\Camunda\Model\SchemaLogEntryDto[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\NookeST\Camunda\Model\SchemaLogEntryDto[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\NookeST\Camunda\Model\SchemaLogEntryDto[]',
     ...
     * @param  int $first_result Pagination of results. Specifies the index of the first result to return. (optional)
     * @param  int $max_results Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left. (optional)
     * @param  \NookeST\Camunda\Model\SchemaLogQueryDto $schema_log_query_dto schema_log_query_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NookeST\Camunda\Model\SchemaLogEntryDto[]
     ...
     * @param  int $first_result Pagination of results. Specifies the index of the first result to return. (optional)
     * @param  int $max_results Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left. (optional)
     * @param  \NookeST\Camunda\Model\SchemaLogQueryDto $schema_log_query_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \NookeST\Camunda\Model\SchemaLogEntryDto[], HTTP status code, HTTP response headers (array of strings)
