...
class MetricsApi
{
     ...
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NookeST\Camunda\Model\MetricsResultDto
     */
     ...
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \NookeST\Camunda\Model\MetricsResultDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMetricsWithHttpInfo($metrics_name, $start_date = null, $end_date = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\NookeST\Camunda\Model\MetricsResultDto' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\NookeST\Camunda\Model\MetricsResultDto', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\NookeST\Camunda\Model\MetricsResultDto';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\NookeST\Camunda\Model\MetricsResultDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NookeST\Camunda\Model\MetricsIntervalResultDto[]|\NookeST\Camunda\Model\ExceptionDto
     */
     ...
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \NookeST\Camunda\Model\MetricsIntervalResultDto[]|\NookeST\Camunda\Model\ExceptionDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function intervalWithHttpInfo($name = null, $reporter = null, $start_date = null, $end_date = null, $first_result = null, $max_results = null, $interval = '900', $aggregate_by_reporter = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\NookeST\Camunda\Model\MetricsIntervalResultDto[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\NookeST\Camunda\Model\MetricsIntervalResultDto[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\NookeST\Camunda\Model\MetricsIntervalResultDto[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\NookeST\Camunda\Model\MetricsIntervalResultDto[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
