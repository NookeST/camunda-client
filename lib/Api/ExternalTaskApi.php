...
class ExternalTaskApi
{
     ...
     * @param  \NookeST\Camunda\Model\CompleteExternalTaskDto $complete_external_task_dto complete_external_task_dto (optional)
     *
     ...
     *
     * @param  string $id The id of the task to complete. (required)
     * @param  \NookeST\Camunda\Model\CompleteExternalTaskDto $complete_external_task_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function completeExternalTaskResourceRequest($id, $complete_external_task_dto = null)
    {
        ...
        if (isset($complete_external_task_dto)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($complete_external_task_dto));
            } else {
                $httpBody = $complete_external_task_dto;
            }
     ...
     * @param  \NookeST\Camunda\Model\ExtendLockOnExternalTaskDto $extend_lock_on_external_task_dto extend_lock_on_external_task_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $id The id of the external task. (required)
     * @param  \NookeST\Camunda\Model\ExtendLockOnExternalTaskDto $extend_lock_on_external_task_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function extendLockRequest($id, $extend_lock_on_external_task_dto = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($extend_lock_on_external_task_dto)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($extend_lock_on_external_task_dto));
            } else {
                $httpBody = $extend_lock_on_external_task_dto;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * Fetch and Lock
     *
     * @param  \NookeST\Camunda\Model\FetchExternalTasksDto $fetch_external_tasks_dto fetch_external_tasks_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NookeST\Camunda\Model\LockedExternalTaskDto[]|\NookeST\Camunda\Model\ExceptionDto
     */
     ...
     * Fetch and Lock
     *
     * @param  \NookeST\Camunda\Model\FetchExternalTasksDto $fetch_external_tasks_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \NookeST\Camunda\Model\LockedExternalTaskDto[]|\NookeST\Camunda\Model\ExceptionDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function fetchAndLockWithHttpInfo($fetch_external_tasks_dto = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\NookeST\Camunda\Model\LockedExternalTaskDto[]' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\NookeST\Camunda\Model\LockedExternalTaskDto[]', []),
            ...
            $returnType = '\NookeST\Camunda\Model\LockedExternalTaskDto[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\NookeST\Camunda\Model\LockedExternalTaskDto[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function fetchAndLockRequest($fetch_external_tasks_dto = null)
    {
        ...
        if (isset($fetch_external_tasks_dto)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($fetch_external_tasks_dto));
            } else {
                $httpBody = $fetch_external_tasks_dto;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NookeST\Camunda\Model\ExternalTaskDto|\NookeST\Camunda\Model\ExceptionDto
     */
     ...
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \NookeST\Camunda\Model\ExternalTaskDto|\NookeST\Camunda\Model\ExceptionDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getExternalTaskWithHttpInfo($id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\NookeST\Camunda\Model\ExternalTaskDto' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\NookeST\Camunda\Model\ExternalTaskDto', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
            ...
            $returnType = '\NookeST\Camunda\Model\ExternalTaskDto';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\NookeST\Camunda\Model\ExternalTaskDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return string|\NookeST\Camunda\Model\ExceptionDto
     */
     ...
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of string|\NookeST\Camunda\Model\ExceptionDto, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getExternalTaskErrorDetailsRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @param  \DateTime $lock_expiration_after Restrict to external tasks that have a lock that expires after a given date. By [default](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/), the date must have the format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;, e.g., &#x60;2013-01-23T14:42:45.000+0200&#x60;. (optional)
     * @param  \DateTime $lock_expiration_before Restrict to external tasks that have a lock that expires before a given date. By [default](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/), the date must have the format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;, e.g., &#x60;2013-01-23T14:42:45.000+0200&#x60;. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getExternalTasksRequest($external_task_id = null, $external_task_id_in = null, $topic_name = null, $worker_id = null, $locked = null, $not_locked = null, $with_retries_left = null, $no_retries_left = null, $lock_expiration_after = null, $lock_expiration_before = null, $activity_id = null, $activity_id_in = null, $execution_id = null, $process_instance_id = null, $process_instance_id_in = null, $process_definition_id = null, $tenant_id_in = null, $active = null, $suspended = null, $priority_higher_than_or_equals = null, $priority_lower_than_or_equals = null, $sort_by = null, $sort_order = null, $first_result = null, $max_results = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getExternalTasksCountRequest($external_task_id = null, $external_task_id_in = null, $topic_name = null, $worker_id = null, $locked = null, $not_locked = null, $with_retries_left = null, $no_retries_left = null, $lock_expiration_after = null, $lock_expiration_before = null, $activity_id = null, $activity_id_in = null, $execution_id = null, $process_instance_id = null, $process_instance_id_in = null, $process_definition_id = null, $tenant_id_in = null, $active = null, $suspended = null, $priority_higher_than_or_equals = null, $priority_lower_than_or_equals = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTopicNamesRequest($with_locked_tasks = null, $with_unlocked_tasks = null, $with_retries_left = null)
    {
     ...
     * @param  \NookeST\Camunda\Model\ExternalTaskBpmnError $external_task_bpmn_error external_task_bpmn_error (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $id The id of the external task in which context a BPMN error is reported. (required)
     * @param  \NookeST\Camunda\Model\ExternalTaskBpmnError $external_task_bpmn_error (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function handleExternalTaskBpmnErrorRequest($id, $external_task_bpmn_error = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($external_task_bpmn_error)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($external_task_bpmn_error));
            } else {
                $httpBody = $external_task_bpmn_error;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @param  \NookeST\Camunda\Model\ExternalTaskFailureDto $external_task_failure_dto external_task_failure_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $id The id of the external task to report a failure for. (required)
     * @param  \NookeST\Camunda\Model\ExternalTaskFailureDto $external_task_failure_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function handleFailureRequest($id, $external_task_failure_dto = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($external_task_failure_dto)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($external_task_failure_dto));
            } else {
                $httpBody = $external_task_failure_dto;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     *
     * @param  string $id The id of the external task. (required)
     * @param  \NookeST\Camunda\Model\LockExternalTaskDto $lock_external_task_dto lock_external_task_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function lock($id, $lock_external_task_dto = null)
    {
        $this->lockWithHttpInfo($id, $lock_external_task_dto);
    }
     ...
     *
     * @param  string $id The id of the external task. (required)
     * @param  \NookeST\Camunda\Model\LockExternalTaskDto $lock_external_task_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function lockWithHttpInfo($id, $lock_external_task_dto = null)
    {
        $request = $this->lockRequest($id, $lock_external_task_dto);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function lockAsync($id, $lock_external_task_dto = null)
    {
        return $this->lockAsyncWithHttpInfo($id, $lock_external_task_dto)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function lockAsyncWithHttpInfo($id, $lock_external_task_dto = null)
    {
        $returnType = '';
        $request = $this->lockRequest($id, $lock_external_task_dto);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function lockRequest($id, $lock_external_task_dto = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // for model (json/xml)
        if (isset($lock_external_task_dto)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($lock_external_task_dto));
            } else {
                $httpBody = $lock_external_task_dto;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @param  int $first_result Pagination of results. Specifies the index of the first result to return. (optional)
     * @param  int $max_results Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left. (optional)
     * @param  \NookeST\Camunda\Model\ExternalTaskQueryDto $external_task_query_dto external_task_query_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NookeST\Camunda\Model\ExternalTaskDto[]|\NookeST\Camunda\Model\ExceptionDto
     ...
     * @param  int $first_result Pagination of results. Specifies the index of the first result to return. (optional)
     * @param  int $max_results Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left. (optional)
     * @param  \NookeST\Camunda\Model\ExternalTaskQueryDto $external_task_query_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \NookeST\Camunda\Model\ExternalTaskDto[]|\NookeST\Camunda\Model\ExceptionDto, HTTP status code, HTTP response headers (array of strings)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function queryExternalTasksRequest($first_result = null, $max_results = null, $external_task_query_dto = null)
    {
        ...
        if (isset($external_task_query_dto)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($external_task_query_dto));
            } else {
                $httpBody = $external_task_query_dto;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function queryExternalTasksCountRequest($external_task_query_dto = null)
    {
     ...
     * @param  \NookeST\Camunda\Model\PriorityDto $priority_dto priority_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $id The id of the external task to set the priority for. (required)
     * @param  \NookeST\Camunda\Model\PriorityDto $priority_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function setExternalTaskResourcePriorityRequest($id, $priority_dto = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @param  \NookeST\Camunda\Model\RetriesDto $retries_dto retries_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $id The id of the external task to set the number of retries for. (required)
     * @param  \NookeST\Camunda\Model\RetriesDto $retries_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function setExternalTaskResourceRetriesRequest($id, $retries_dto = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * Set Retries Sync
     *
     * @param  \NookeST\Camunda\Model\SetRetriesForExternalTasksDto $set_retries_for_external_tasks_dto set_retries_for_external_tasks_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * Set Retries Sync
     *
     * @param  \NookeST\Camunda\Model\SetRetriesForExternalTasksDto $set_retries_for_external_tasks_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function setExternalTaskRetriesRequest($set_retries_for_external_tasks_dto = null)
    {
        ...
        if (isset($set_retries_for_external_tasks_dto)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($set_retries_for_external_tasks_dto));
            } else {
                $httpBody = $set_retries_for_external_tasks_dto;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function setExternalTaskRetriesAsyncOperationRequest($set_retries_for_external_tasks_dto = null)
    {
