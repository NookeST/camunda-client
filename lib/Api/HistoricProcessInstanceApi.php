...
class HistoricProcessInstanceApi
{
     ...
     * Delete Async (POST)
     *
     * @param  \NookeST\Camunda\Model\DeleteHistoricProcessInstancesDto $delete_historic_process_instances_dto delete_historic_process_instances_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Delete Async (POST)
     *
     * @param  \NookeST\Camunda\Model\DeleteHistoricProcessInstancesDto $delete_historic_process_instances_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NookeST\Camunda\Model\HistoricProcessInstanceDto|\NookeST\Camunda\Model\ExceptionDto
     */
     ...
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \NookeST\Camunda\Model\HistoricProcessInstanceDto|\NookeST\Camunda\Model\ExceptionDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getHistoricProcessInstanceWithHttpInfo($id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\NookeST\Camunda\Model\HistoricProcessInstanceDto' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\NookeST\Camunda\Model\HistoricProcessInstanceDto', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
            ...
            $returnType = '\NookeST\Camunda\Model\HistoricProcessInstanceDto';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\NookeST\Camunda\Model\HistoricProcessInstanceDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \DateTime $started_after Restrict to instances that were started after the given date. By [default](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/), the date must have the format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;, e.g., &#x60;2016-01-23T14:42:45.000+0200&#x60;. (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NookeST\Camunda\Model\DurationReportResultDto[]|\NookeST\Camunda\Model\ExceptionDto|\NookeST\Camunda\Model\ExceptionDto
     */
     ...
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \NookeST\Camunda\Model\DurationReportResultDto[]|\NookeST\Camunda\Model\ExceptionDto|\NookeST\Camunda\Model\ExceptionDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getHistoricProcessInstanceDurationReportWithHttpInfo($report_type, $period_unit, $process_definition_id_in = null, $process_definition_key_in = null, $started_before = null, $started_after = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\NookeST\Camunda\Model\DurationReportResultDto[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\NookeST\Camunda\Model\DurationReportResultDto[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\NookeST\Camunda\Model\DurationReportResultDto[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\NookeST\Camunda\Model\DurationReportResultDto[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \DateTime $executed_activity_after Restrict to instances that executed an activity after the given date (inclusive). By [default](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/), the date must have the format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;, e.g., &#x60;2013-01-23T14:42:45.000+0200&#x60;. (optional)
     * @param  \DateTime $executed_activity_before Restrict to instances that executed an activity before the given date (inclusive). By [default](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/), the date must have the format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;, e.g., &#x60;2013-01-23T14:42:45.000+0200&#x60;. (optional)
     * @param  \DateTime $executed_job_after Restrict to instances that executed an job after the given date (inclusive). By [default](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/), the date must have the format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;, e.g., &#x60;2013-01-23T14:42:45.000+0200&#x60;. (optional)
     * @param  \DateTime $executed_job_before Restrict to instances that executed an job before the given date (inclusive). By [default](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/), the date must have the format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;, e.g., &#x60;2013-01-23T14:42:45.000+0200&#x60;. (optional)
     ...
     * @param  int $first_result Pagination of results. Specifies the index of the first result to return. (optional)
     * @param  int $max_results Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left. (optional)
     * @param  \NookeST\Camunda\Model\HistoricProcessInstanceQueryDto $historic_process_instance_query_dto historic_process_instance_query_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NookeST\Camunda\Model\HistoricProcessInstanceDto[]|\NookeST\Camunda\Model\ExceptionDto
     ...
     * @param  int $first_result Pagination of results. Specifies the index of the first result to return. (optional)
     * @param  int $max_results Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left. (optional)
     * @param  \NookeST\Camunda\Model\HistoricProcessInstanceQueryDto $historic_process_instance_query_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \NookeST\Camunda\Model\HistoricProcessInstanceDto[]|\NookeST\Camunda\Model\ExceptionDto, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  \NookeST\Camunda\Model\SetRemovalTimeToHistoricProcessInstancesDto $set_removal_time_to_historic_process_instances_dto set_removal_time_to_historic_process_instances_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NookeST\Camunda\Model\BatchDto|\NookeST\Camunda\Model\ExceptionDto
     ...
     * Set Removal Time Async (POST)
     *
     * @param  \NookeST\Camunda\Model\SetRemovalTimeToHistoricProcessInstancesDto $set_removal_time_to_historic_process_instances_dto (optional)
     *
     * @throws \NookeST\Camunda\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \NookeST\Camunda\Model\BatchDto|\NookeST\Camunda\Model\ExceptionDto, HTTP status code, HTTP response headers (array of strings)
