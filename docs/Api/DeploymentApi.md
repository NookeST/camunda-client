...
```php
createDeployment($tenant_id, $deployment_source, $deploy_changed_only, $enable_duplicate_filtering, $deployment_name, $data): \NookeST\Camunda\Model\DeploymentWithDefinitionsDto
```
...
$apiInstance = new NookeST\Camunda\Api\DeploymentApi(
...
[**\NookeST\Camunda\Model\DeploymentWithDefinitionsDto**](../Model/DeploymentWithDefinitionsDto.md)
...
```php
getDeployment($id): \NookeST\Camunda\Model\DeploymentDto
```
...
[**\NookeST\Camunda\Model\DeploymentDto**](../Model/DeploymentDto.md)
...
```php
getDeploymentResource($id, $resource_id): \NookeST\Camunda\Model\DeploymentResourceDto
```
...
[**\NookeST\Camunda\Model\DeploymentResourceDto**](../Model/DeploymentResourceDto.md)
...
```php
getDeploymentResources($id): \NookeST\Camunda\Model\DeploymentResourceDto[]
```
...
```php
getDeployments($id, $name, $name_like, $source, $without_source, $tenant_id_in, $without_tenant_id, $include_deployments_without_tenant_id, $after, $before, $sort_by, $sort_order, $first_result, $max_results): \NookeST\Camunda\Model\DeploymentDto[]
```
...
```php
getDeploymentsCount($id, $name, $name_like, $source, $without_source, $tenant_id_in, $without_tenant_id, $include_deployments_without_tenant_id, $after, $before): \NookeST\Camunda\Model\CountResultDto
```
...
```php
redeploy($id, $redeployment_dto): \NookeST\Camunda\Model\DeploymentWithDefinitionsDto
```
...
$redeployment_dto = {"resourceIds":["aResourceId"],"resourceNames":["aResourceName"],"source":"cockpit"}; // \NookeST\Camunda\Model\RedeploymentDto
 ...
 **redeployment_dto** | [**\NookeST\Camunda\Model\RedeploymentDto**](../Model/RedeploymentDto.md)|  | [optional]
