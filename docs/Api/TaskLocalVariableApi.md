# NookeST\Camunda\TaskLocalVariableApi
...
$apiInstance = new NookeST\Camunda\Api\TaskLocalVariableApi(
...
```php
getTaskLocalVariable($id, $var_name, $deserialize_value): \NookeST\Camunda\Model\VariableValueDto
```
...
```php
getTaskLocalVariables($id, $deserialize_values): array<string,\NookeST\Camunda\Model\VariableValueDto>
```
