...
```php
createIncident($id, $create_incident_dto): \NookeST\Camunda\Model\IncidentDto
```
...
$apiInstance = new NookeST\Camunda\Api\ExecutionApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client()
);
$id = 'id_example'; // string | The id of the execution to create a new incident for.
$create_incident_dto = {"incidentType":"aType","configuration":"aConfiguration"}; // \NookeST\Camunda\Model\CreateIncidentDto
 ...
 **create_incident_dto** | [**\NookeST\Camunda\Model\CreateIncidentDto**](../Model/CreateIncidentDto.md)|  | [optional]
...
```php
getExecution($id): \NookeST\Camunda\Model\ExecutionDto
```
...
[**\NookeST\Camunda\Model\ExecutionDto**](../Model/ExecutionDto.md)
...
```php
getLocalExecutionVariable($id, $var_name, $deserialize_value): \NookeST\Camunda\Model\VariableValueDto
```
...
```php
getLocalExecutionVariables($id, $deserialize_values): array<string,\NookeST\Camunda\Model\VariableValueDto>
```
...
```php
getMessageEventSubscription($id, $message_name): \NookeST\Camunda\Model\EventSubscriptionDto
```
...
```php
queryExecutions($first_result, $max_results, $execution_query_dto): \NookeST\Camunda\Model\ExecutionDto[]
```
...
$first_result = 56; // int | Pagination of results. Specifies the index of the first result to return.
$max_results = 56; // int | Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left.
$execution_query_dto = {"variables":[{"name":"myVariable","operator":"eq","value":"camunda"},{"name":"mySecondVariable","operator":"neq","value":124}],"processDefinitionId":"aProcessDefinitionId","sorting":[{"sortBy":"definitionKey","sortOrder":"asc"},{"sortBy":"instanceId","sortOrder":"desc"}]}; // \NookeST\Camunda\Model\ExecutionQueryDto
 ...
 **first_result** | **int**| Pagination of results. Specifies the index of the first result to return. | [optional]
 **max_results** | **int**| Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left. | [optional]
 **execution_query_dto** | [**\NookeST\Camunda\Model\ExecutionQueryDto**](../Model/ExecutionQueryDto.md)|  | [optional]
...
```php
queryExecutionsCount($execution_query_dto): \NookeST\Camunda\Model\CountResultDto
```
...
$execution_query_dto = {"variables":[{"name":"myVariable","operator":"eq","value":"camunda"},{"name":"mySecondVariable","operator":"neq","value":124}],"processDefinitionId":"aProcessDefinitionId"}; // \NookeST\Camunda\Model\ExecutionQueryDto
...
$execution_trigger_dto = {"variables":{"myVariable":{"value":"camunda","type":"String"},"mySecondVariable":{"value":124,"type":"Integer"}}}; // \NookeST\Camunda\Model\ExecutionTriggerDto
 ...
 **execution_trigger_dto** | [**\NookeST\Camunda\Model\ExecutionTriggerDto**](../Model/ExecutionTriggerDto.md)|  | [optional]
...
$execution_trigger_dto = {"variables":{"aVariable":{"value":true,"type":"Boolean"},"anotherVariable":{"value":42,"type":"Integer"}}}; // \NookeST\Camunda\Model\ExecutionTriggerDto
